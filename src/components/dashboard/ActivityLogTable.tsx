...
export default function ActivityLogTable({
  ...
  const getActionBadge = (action: string) => {
    ...
    if (action.startsWith("FEEDBACK")) {
      return (
        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-bold bg-pink-500/15 text-pink-300 border border-pink-500/30">
          <MessageSquare className="w-3 h-3 text-pink-400" />
          Kritik/Saran
        </span>
      );
    }
    if (action.startsWith("VIP_") || action === "UPDATE_STATUS") {
      return (
        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-bold bg-amber-500/15 text-amber-300 border border-amber-500/30">
          ...
          {isOutletView ? (
            <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
              ...
              <select
                ...
                aria-label="Filter Aktivitas Outlet"
                className="px-3 py-2 rounded-xl bg-slate-950/60 border border-slate-800 text-slate-200 text-xs focus:outline-none focus:border-amber-500 transition-all cursor-pointer"
              >
                <option value="ALL">Semua Aktivitas Toko</option>
                <option value="SCAN">Scan Meja Pengunjung</option>
                <option value="FIVE_STAR">Ulasan Bintang 5</option>
                <option value="FOUR_STAR">Ulasan Bintang 4</option>
                <option value="FEEDBACK">Kritik & Masukan</option>
                <option value="VIP">Status VIP Member</option>
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
              ...
              >
                ...
                <option value="FOUR_STAR">Ulasan Bintang 4</option>
                <option value="FEEDBACK">Kritik & Masukan</option>
                <option value="VIP">Status & Perpanjangan VIP</option>
